...
public class UsuarioTest {
	...
	public void setUp() {
		...
		this.p1 = new Propiedad("Propiedad 1","La Plata","La prop 1",500,this.p);
		this.r1= new Reserva(periodo1,p1,this.usuario3);
	}
	
	@Test
	public void testRegistrarPropiedad() {
		assertNotNull(this.usuario1.registrarPropiedad("La propiedad 1", "Buenas vistas", "Avenida 1", 600,this.p));
	...
	public void testCalcularIngresos() {
		...
		this.usuario1.registrarPropiedad("Ventanas", "Buena vista", "Calle 11", 600,this.p).hacerReserva(periodo2, usuario2);
		...
		this.usuario2.registrarPropiedad("Balcones", "Espaciosa", "Avenida General", 1000,this.p).hacerReserva(periodo3, usuario3); //29 dias, $29000
