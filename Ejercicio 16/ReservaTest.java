...
public class ReservaTest {
	...
	private void setUp() {
		...
		Propiedad p1 = new Propiedad("Propiedad 1","La Plata","La prop 1",500,pol1);
		Propiedad p2 = new Propiedad("Propiedad 2","La Pampa","La prop 2",700,pol2);
		Propiedad p3 = new Propiedad("Propiedad 3","Mar del Plata","La prop 3",1000,pol3);
		...
		Propiedad p4 = new Propiedad("Propiead 4","La Matanza", "No se alquila",0,pol1);
	...
	public void testCancelarReserva() {
		assertEquals(0,this.reserva1.cancelarReserva(LocalDate.of(2020, 7, 24)));
		assertEquals(this.reserva2.calcularPrecio(periodo2), this.reserva2.cancelarReserva(LocalDate.of(2020, 5, 14)));
		assertEquals(0,this.reserva2.cancelarReserva(LocalDate.of(2022, 4, 11)));
		assertEquals(this.reserva3.calcularPrecio(periodo3), this.reserva3.cancelarReserva(LocalDate.of(2019, 4, 17)));
		assertEquals(this.reserva3.calcularPrecio(periodo3)/2, this.reserva3.cancelarReserva(LocalDate.of(2021, 7, 13)));
		assertEquals(0,this.reserva3.cancelarReserva(LocalDate.of(2021, 8, 30)));
	}
}
