...
public class OOBnBTest {
	...
	public void testGetPropiedadesDisponibles() {
		...
		Politica p = new PoliticaEstricta();
		this.sistema1.registrarUsuario("Camilo", "Calle 20", 400).registrarPropiedad("Propiedad de Camilo", "Buena fachada", "Avenida del Mar", 500,p);
		assertEquals(1,this.sistema1.getSizePropiedadesDisponibles(periodo1));
		this.sistema1.registrarUsuario("Alma", "Calle 25", 7100).registrarPropiedad("Propiedad de Alma", "Espaciosa", "Avenida del Mar", 750,p).hacerReserva(periodo1, new Usuario("Maria","Calle San Martin",120));
		assertEquals(1,this.sistema1.getSizePropiedadesDisponibles(new DateLapse(LocalDate.of(2022, 1, 10), LocalDate.of(2022, 1, 15))));		
		this.sistema2.registrarUsuario("Camilo", "Calle 20", 400).registrarPropiedad("Propiedad de Camilo", "Buena fachada", "Avenida del Mar", 500,p).hacerReserva(periodo1, new Usuario("German","Avenida del Cielo",114));
		assertEquals(0,this.sistema2.getSizePropiedadesDisponibles(periodo1));
		this.sistema2.registrarUsuario("Dario", "Calle 22", 550).registrarPropiedad("Propiedad de Dario", "Buena iluminacion", "Calle Belgrano", 600,p);
