...
public class Propiedad {
    ...
    public Propiedad(String n, String dir, String des, double pxn, Politica pol) {
	   	 this.nombre= n;
	   	 this.direccion= dir;
    ...
    public double cancelarReserva(double monto, LocalDate fechaCancelacion, LocalDate fechaInicio) {
    	return this.politica.calcularReembolso(monto, fechaCancelacion, fechaInicio);
    } // cancelar reserva
}
