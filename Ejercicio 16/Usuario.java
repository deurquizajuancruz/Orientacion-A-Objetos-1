...
public class Usuario {
    ...
    public Propiedad registrarPropiedad(String nombre,String descripcion, String direccion, double precioXNoche, Politica pol) {
    	Propiedad p = new Propiedad(nombre, descripcion, direccion, precioXNoche,pol);
